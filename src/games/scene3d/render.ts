...
export class WebGlRender extends tge.Render {
    ...
    createWorld() {
        ...
        for(let i=0; i<8; i++) {
            ...
            //material2.mainTexture = tge.textureManager.getTexture(WebGlRender.box_main_texture);
            //material2.normalMap = tge.textureManager.getTexture(WebGlRender.box_normal_map);
        ...
        for(let i=0; i<10; i++) {
            for(let j=0; j<10; j++) {
                //this._mesh2[i] = meshRoot.addMeshNode(tge.Mesh.createCube(), material2);
